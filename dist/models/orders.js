...
async function createOrdersTable() {
  ...
  `);
    ...
    const expected = {
        ...
        provider_service_id: `ALTER TABLE orders ADD COLUMN provider_service_id INTEGER`,
        ...
        interval: `ALTER TABLE orders ADD COLUMN interval INTEGER NOT NULL DEFAULT 0`,
