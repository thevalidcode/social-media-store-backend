...
async function createServiceTable() {
    ...
    CREATE TABLE IF NOT EXISTS services (
      ...
      provider TEXT REFERENCES providers(domain) ON DELETE CASCADE,
  ...
  `);
    ...
    const expected = {
        ...
        category: `ALTER TABLE services ADD COLUMN category TEXT NOT NULL REFERENCES categories(name) ON DELETE CASCADE`,
        ...
        provider: `ALTER TABLE services ADD COLUMN provider TEXT REFERENCES providers(url) ON DELETE CASCADE`,
