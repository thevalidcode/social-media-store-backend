...
const newOrder = ({ username, id, url, number, price, user_balance, service_id, provider, logo, }) => `
    <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8">
...
const newFailedOrder = ({ username, id, logo, url, number, user_balance, service_id, price, provider, provider_error, }) => `
    <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8">
