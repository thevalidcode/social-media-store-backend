 ...
 */
export default function convertCurrency(sourceAmount: number | string, sourceCurrency: string, targetCurrency: string, ratesData: Record<string, number>): number | undefined;
