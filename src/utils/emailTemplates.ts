// Template-specific variable definitions
...
// Type for all templates
interface EmailTemplates {
  verification_code: (v: VerificationCodeVars) => string;
  new_user: (v: NewUserVars) => string;
  new_order: (v: NewOrderVars) => string;
  new_refill: (v: RefillVars) => string;
  new_failed_refill: (v: FailedRefillVars) => string;
  new_failed_order: (v: FailedOrderVars) => string;
  new_service: (v: NewServiceVars) => string;
  new_support: (v: NewSupportVars) => string;
  new_message: (v: NewMessageVars) => string;
  funds_added: (v: FundsAddedVars) => string;
